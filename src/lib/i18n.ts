...
const D = {
  ...
  "common.prefTime": { th: "ช่วงเวลาติดต่อ", en: "Preferred contact time" },
  ...
  "leads.total": { th: "ลีด", en: "leads" },
  "leads.page": { th: "หน้า {n} จาก {m}", en: "Page {n} of {m}" },
  "leads.prev": { th: "ก่อนหน้า", en: "Prev" },
  "leads.next": { th: "ถัดไป", en: "Next" },
  "leads.from": { th: "จาก", en: "From" },
  "leads.to": { th: "ถึง", en: "To" },
  "leads.clear": { th: "ล้างตัวกรอง", en: "Clear filters" },
  ...
  "visit.title": { th: "นัดดูโชว์รูม", en: "Schedule showroom visit" },
  "visit.showroom": { th: "นัดดูโชว์รูม", en: "Showroom visit" },
  ...
  "call.save": { th: "บันทึกผล", en: "Save result" },
  "call.call": { th: "โทรหา", en: "Call" },
  "call.now": { th: "โทรออกเลย", en: "Call now" },
  "call.outcome": { th: "ผลการโทร?", en: "Call outcome?" },
  "call.contacted": { th: "ติดต่อแล้ว", en: "Contacted" },
  "call.noAnswer": { th: "ไม่รับสาย", en: "No answer" },
  "call.appointment": { th: "นัดหมาย", en: "Appointment" },
  "call.other": { th: "อื่นๆ", en: "Other" },
  "call.history": { th: "ประวัติโทร", en: "Call history" },
  "call.copy": { th: "คัดลอกเบอร์", en: "Copy number" },
  "call.copied": { th: "คัดลอกแล้ว", en: "Copied" },
  "call.fromPhone": { th: "กดโทรจากมือถือของคุณ", en: "Call from your phone" },
  "call.notePlaceholder": { th: "โน้ต (เช่น ลูกค้าให้โทรกลับเย็นนี้)", en: "Note (e.g. call back tonight)" },
  "call.noCalls": { th: "ยังไม่มีประวัติโทร", en: "No calls yet" },
  ...
  "stage.site_visit": { th: "นัดดูโชว์รูม", en: "Showroom visit" },
